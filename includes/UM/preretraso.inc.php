...
// +-------------------------------------------------+
// $Id: preretraso.inc.php,v 1.0 Marcelo Vidal 02/12/2011 $
...
$rqt = "select expl_cb from pret, exemplaires where pret_idempr='".$id_empr."' and pret_retour = curdate()+$cant_dias and pret_idexpl=expl_id order by pret_date " ;
...
while ($data = mysql_fetch_array($req)) {
	...
	$requete.= " IF(pret_retour>(sysdate()+1),0,1) as retard, notices_m.tparent_id, notices_m.tnvol " ; 
